...
func (p *searchstaxProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewAccountBackupsDataSource,
		NewAlertMetricsDataSource,
		NewAlertsDataSource,
		NewAPIKeyDeploymentsDataSource,
		NewAuthTokenDataSource,
		NewBackupSchedulesDataSource,
		NewBasicAuthDataSource,
		NewCustomJarsDataSource,
		NewDeploymentAPIKeysDataSource,
		NewDeploymentBackupsDataSource,
		NewDeploymentCollectionsHealthDataSource,
		NewDeploymentDataSource,
		NewDeploymentHealthDataSource,
		NewDeploymentServerHostStatusDataSource,
		NewDeploymentServersDataSource,
		NewDeploymentsByTagDataSource,
		...
		NewTagsDataSource,
		NewUsageDataSource,
		NewUsageExtendedDataSource,
		NewUsersDataSource,
		NewWebhooksDataSource,
		NewZookeeperConfigDataSource,
		NewZookeeperConfigDownloadDataSource,
...
func (p *searchstaxProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewDeploymentRollingRestartResource,
		NewDeploymentSolrResource,
